...
int main() {
 ...
 m.insert(make_pair("fourth",40));
    ...
    int m1 = m["first"]; // m에서 key값을 넣어 value를 얻어 채우세요
    int m2 = m["second"]; // m에서 key값을 넣어 value를 얻어 채우세요
    int m3 = m["third"]; // m에서 key값을 넣어 value를 얻어 채우세요
    int m4 = m["fourth"]; // m에서 key값을 넣어 value를 얻어 채우세요
