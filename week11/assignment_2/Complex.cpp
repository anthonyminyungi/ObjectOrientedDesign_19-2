...
Number *Complex::add(Number * num) {
    ...
    {
        Integer *it = dynamic_cast<Integer *>(num);
        this->set_val(this->real() + it->val(), this->imag());
        delete it;
        return this;
    }
    else if (num->types() == FLOAT)
    {
        Float *ft = dynamic_cast<Float *>(num);
        this->set_val(this->real() + ft->val(), this->imag()) ;
        delete ft;
        return this;
    }
    else if (num->types() == COMPLEX)
    {
        Complex *cx = dynamic_cast<Complex *>(num);
        this->set_val(std::make_pair(this->real() + cx->real(),this->imag() + cx->imag()));
        delete cx;
        return this;
    }
    else
...
Number *Complex::mul(Number * num) {
    ...
    {
        Integer *it = dynamic_cast<Integer *>(num);
        this->set_val(this->real() * it->val(), it->val() * this->imag());
        delete it;
        return this;
    }
    else if (num->types() == FLOAT)
    {
        Float *ft = dynamic_cast<Float *>(num);
        this->set_val(this->real() * ft->val(), ft->val() * this->imag()) ;
        delete ft;
        return this;
    }
    else if (num->types() == COMPLEX)
    {
        Complex *cx = dynamic_cast<Complex *>(num);
        this->set_val(std::make_pair(this->real() * cx->real() - this->imag() * cx->imag(), this->real() * cx->imag() + this->imag() * cx->real() ) ) ;
        delete cx;
        return this;
    }
    else
...
Number *Complex::div(Number * num) {
    ...
    if (num->types() == INTEGER)
    {
        ...
        Integer *it = dynamic_cast<Integer *>(num);
        if(it->val() != 0){
            this->set_val(this->real() / it->val(), this->imag() / it->val());
            delete it;
        }
        return this;
    }
    else if (num->types() == FLOAT)
    {
        Float *ft = dynamic_cast<Float *>(num);
        if(ft->val() != 0){
            this->set_val(this->real() / ft->val(), this->imag() / ft->val());
            delete ft;
        }
        return this;
    }
